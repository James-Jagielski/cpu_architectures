...
TESTS = {
    ...
    "mux": {
        "top": "test_muxes",
        "files": ["tests/test_muxes.sv", "mux2.sv","mux4.sv","mux8.sv","mux16.sv","mux32.sv"]
    },
    "decoder": {
        "top": "test_decoders",
        "files": ["tests/test_decoders.sv", "decoder_1_to_2.sv","decoder_2_to_4.sv","decoder_3_to_8.sv","decoder_4_to_16.sv","decoder_5_to_32.sv"]
    },
    "comparators": {
        "top": "test_comparators",
        "files": ["tests/test_comparators.sv", "comparator_eq.sv", "comparator_lt.sv", "adder_1.sv", "adder_n.sv"]
    },
    "alu": {
        "top": "test_alu",
        "files": [
